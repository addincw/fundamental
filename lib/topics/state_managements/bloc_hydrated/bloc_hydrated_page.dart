...
// fungsi untuk menyimpan state saat aplikasi tertutup (seperti local storage / shared preference)
class BlocHydratedPage extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(title: Text('State Management - Bloc Hydrated')),
      body: Center(
        child: Column(
